...
- Método histórico: IBM OS/360 (chamado MFT)
- Problema: tamanhos diferentes de processos → desperdício de memória

* Particionamento Dinâmico: Brechas

- Partições variáveis (MVT): generalização das partições fixas
...
* Particionamento Dinâmico: Carregamento de Processos
...
- SO verifica vizinhos ao liberar: mescla brechas contíguas
